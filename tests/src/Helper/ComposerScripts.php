...
namespace Drupal\Tests\marvin_rte\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-rte-tests-project_01',
      'description' => 'drupal/marvin-rte-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_rte']['fixtures']['filesToSymlink'] ?? [];
